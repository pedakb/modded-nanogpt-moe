...
forward (train_gpt_simple.py line NNN)" names GPT.forward, not MoE.forward.
...
def eager_prefix(model, inputs):
    ...
    exactly as they exist in train_gpt_simple.py -- nothing about dispatch
...
def make_head_loss(model):
    ...
    train_gpt_simple.py does not use one either."""
