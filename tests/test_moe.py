...
The model package is import-safe and does not initialize CUDA or distributed
...
def _make_small_gpt(mlp_type="dense", **moe_kwargs):
    ...
    # the active trainer) zeros proj.weight, which would make an
...
def test_head_loss_eager_vs_compiled_fullgraph_parity():
    ...
    # in the active trainer. Check loss AND gradients (w.r.t. both the
